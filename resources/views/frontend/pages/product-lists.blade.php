...
@section('title','NemaFarms || PRODUCT PAGE')
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">GMD{{number_format($product->price,2)}}</del>   GMD{{number_format($org,2)}}  </p>
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    @endforeach
													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
																...
																<del>GMD{{number_format($product->price,2)}}</del>
															</div>
