									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">GMD{{number_format($after_discount,2)}}</span><s>GMD{{number_format($product_detail->price,2)}}</s> </p>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">GMD{{number_format($data->price,2)}}</span>
